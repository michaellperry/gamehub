 ...
 */
router.get('/authenticate_retry', asyncHandler(async (req: Request, res: Response) => {
...
const handleAuthorizationCodeGrant = async (tokenRequest: TokenRequest, res: Response) => {
  ...
  if (authCode.client_id !== tokenRequest.client_id || authCode.redirect_uri !== tokenRequest.redirect_uri) {
