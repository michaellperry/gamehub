        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <section className="mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card>
                        <Card.Header title="Simple Card" subtitle="With header and body" />
                        <Card.Body>
                ...
                <Card>
                    <Card.Body>
                        <div className="prose max-w-none">
                            ...
                            <p>
                                When building new features, use the components from this style guide
                                to ensure consistency across the application. Import components from
...
import { ResourceList } from '../components/organisms';`}
                            ...
                            <p>
                                For custom styling needs, use the predefined Tailwind classes and
                                utilities. Prefer using the color variables defined in the theme
                                (e.g., <code>bg-primary-600</code>) instead of hardcoded color
                                values.
                            </p>

                            <h3 className="mt-6">Icons</h3>
                            <p>
                                Use the Icon component for all icons in the application. This
                                ensures consistent styling and makes it easy to update icons
                                globally.
                            </p>
                            <pre className="bg-gray-100 p-4 rounded dark:bg-gray-800">
                            ...
                            <p>
                                All components are designed to be responsive. Use the provided
                                responsive utilities from Tailwind (e.g., <code>sm:, md:, lg:</code>
