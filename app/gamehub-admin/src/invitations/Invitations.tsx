...
function Invitations() {
    ...
    const handleApproveAcceptance = async (
        ...
        acceptance: AcceptanceViewModel
    ) => {
        if (!tenant) return;
    ...
    const createInvitationButton = (
        <Button onClick={() => setIsCreateModalOpen(true)} icon="add" variant="primary" size="md">
            Create Invitation
        </Button>
    );
                ...
                >
                    <div>
                        ...
                        <div className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                            {invitation.acceptances.length}{' '}
                            {invitation.acceptances.length === 1 ? 'acceptance' : 'acceptances'}
                        </div>
                    </div>
                </ListItem>
                            ...
                            {invitation.acceptances.map((acceptance) => (
                                ...
                                >
                                    ...
                                    <div className="flex space-x-2">
                                        <Button
                                            onClick={() =>
                                                handleApproveAcceptance(invitation, acceptance)
                                            }
                                            variant="primary"
                                            size="sm"
                                        >
                                        ...
                                        <Button
                                            onClick={() =>
                                                handleDeclineAcceptance(invitation, acceptance)
                                            }
                                            variant="danger"
                                            size="sm"
                                        >
        ...
        <div>
            ...
            >
                <p className="text-sm text-gray-500 dark:text-gray-400">
                    This will create a new invitation with a randomly generated code. You can share
                    this code with users to allow them to join your tenant.
                </p>
            </ConfirmModal>
        </div>
    );
